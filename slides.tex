...
\begin{frame}{Conclusion}
    \begin{columns}
        ...
        \begin{itemize}
            \item Derived a closed-form, optimal solution to the aerial network connectivity
                  differential game
            \item Promising simulation results of network connectedness
            \item Penalty for pursuer proximity to fix grouping?
